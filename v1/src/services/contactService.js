...
function remove(id) {
  return storageService.remove(CONTACTS_KEY, id)
}

function save(contact) {
  if (contact._id) return storageService.put(CONTACTS_KEY, contact)
...
async function _createContacts() {
  let contacts = await storageService.query(CONTACTS_KEY)
  if (!contacts || !contacts.length) {
    ...
    await storageService.postMany(CONTACTS_KEY, contacts)
  }
  return contacts
}
